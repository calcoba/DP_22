...
This code has been generated by Carlos Alcoba, Javier Jimenes, Javier Paniagua and Javier Pozo

The project consist on two directories and one .py file. 

main.py: this file containe the core code for the application developed for the project. First the code will perform a preprocessing
