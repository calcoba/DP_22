Code generated for the Data Processes course from the Master of Sc. in Health & Medical Data Analytics (EIT Health, year 2021-2022)
...
Finally the code will allow the user to enter new instances and make predictions with the best model founded.
 ...
 In this case the dataset used is COVID19_data.csv, the one provided for the project. The code is generated in a way that it is able to deal
